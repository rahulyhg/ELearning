				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><a href="{{URL_SUBJECTS_IMPORT}}">{{__('messages.import')}}</a> </li>
				...
				<div class="panel panel-custom">
					<div class="panel-heading">
						...
						<div class="pull-right messages-buttons">
							...
							<a href="{{URL_SUBJECTS_IMPORT}}" class="btn  btn-primary button" >{{ __('messages.import_excel')}}</a>
							<a href="{{URL_SUBJECTS_ADD}}" class="btn  btn-primary button" >{{ __('messages.add_user')}}</a>
  ...
  <div id="home" class="tab-pane fade in active">
    ...
    <div class="table-responsive"> 
						<table class="table table-striped table-bordered datatable" cellspacing="0" width="100%">
							<thead>
								<tr>
								 	<th>{{ __('messages.subject_title')}}</th>
