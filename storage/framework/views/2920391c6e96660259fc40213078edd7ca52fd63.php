							...
							<div class="col-md-3">
								...
								<a href="<?php echo e(URL_STUDENT_EXAMS.$c->slug); ?>">
									...
									<div class="item-details">
										...
										<h3><?php echo e(trans("home.$c->category")); ?></h3>
										<ul>

											<li><i class="icon-bookmark"></i> <?php echo e(count($c->quizzes()).' '.trans('home.Quizzes')); ?></li>

											<li><i class="icon-eye"></i> <?php echo e(trans('home.View')); ?></li>
										</ul>
