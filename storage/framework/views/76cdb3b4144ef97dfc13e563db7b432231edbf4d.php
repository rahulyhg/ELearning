		...
		<aside class="left-sidebar">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<ul class="nav navbar-nav side-nav">
					...
					<?php echo e(trans('home.Children')); ?> </a>

					

					<ul id="children" class="collapse sidemenu-dropdown">

						<li><a href="<?php echo e(URL_USERS_ADD); ?>"> <i class="fa fa-plus"></i><?php echo e(trans('home.Add')); ?></a></li>

						<li><a href="<?php echo e(URL_PARENT_CHILDREN); ?>"> <i class="fa fa-th"></i><?php echo e(trans('home.List')); ?></a></li>
					...
					<i class="fa fa-fw fa-bar-chart" aria-hidden="true"></i><?php echo e(trans('home.Analysis')); ?> </a>
					...
					<ul id="exams" class="collapse sidemenu-dropdown">
						...
						<li><a href="<?php echo e(URL_STUDENT_EXAM_CATEGORIES); ?>"> <i class="fa fa-random"></i><?php echo e(trans('home.Categories')); ?></a></li>

						<li><a href="<?php echo e(URL_STUDENT_EXAM_SERIES_LIST); ?>"> <i class="fa fa-list-ol"></i><?php echo e(trans('home.Exam Series')); ?></a></li>
					...
					<ul id="lms" class="collapse sidemenu-dropdown">
							...
							<li><a href="<?php echo e(URL_STUDENT_LMS_CATEGORIES); ?>"> <i class="fa fa-random"></i><?php echo e(trans('home.Categories')); ?></a></li>

							 

							<li><a href="<?php echo e(URL_STUDENT_LMS_SERIES); ?>"> <i class="fa fa-list-ol"></i><?php echo e(trans(
							'home.Series')); ?></a></li>
					...
					<?php echo e(trans('home.Subscriptions')); ?> </a>
					</li>
