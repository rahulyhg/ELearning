	...
	<?php echo e(Form::label('topic_id', __('messages.topic'))); ?> <span class="text-red">*</span>
	...
	<fieldset class="form-group">
		<?php echo e(Form::label('question', __('messages.question'))); ?> 
	...
	<fieldset class="form-group">
		<?php echo e(Form::label('question_l2', __('messages.question_2nd_language'))); ?> 
	...
	<div  class="row">
	 <div class="col-md-6">
	 <fieldset class="form-group" >
         <?php echo e(Form::label('question_file', __('messages.upload') )); ?> 
         {{question_type}} 
         <span ng-if="question_type=='video'"><?php echo e(__('messages.supported_formats are')); ?> .mp4
         </span>
		 <span ng-if="question_type=='audio'"><?php echo e(__('messages.supported_formats are')); ?> .mp3
         </span>

         <span ng-if="question_type!='audio' && question_type!='video'">(<?php echo e(__('messages.supported_formats are')); ?>.jpeg, .jpg, .png)
         </span>
...
<div class="col-md-6">
	...
	<fieldset class="form-group ">
	<?php echo e(Form::label('difficulty_level', __('messages.difficulty_level'))); ?>
	...
	<fieldset class="form-group">
		<?php echo e(Form::label('explanation_l2', __('messages.explanation_2nd_language'))); ?> 
	...
	<fieldset class="form-group">
		<?php echo e(Form::label('marks', __('messages.marks'))); ?> 
		<span class="text-red">*</span>
	...
	<fieldset class="form-group">
		<?php echo e(Form::label('time_to_spend', __('messages.time_to_spend'))); ?> 
		<span class="text-red">*</span>
		<?php echo e(Form::number('time_to_spend', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => __('messages.in_seconds'),
			'min'=>'1',
