 ...
 ?>
	<div id="wrapper" class="<?php echo e($class); ?>">
		...
		<aside class="left-sidebar">			<div class="collapse navbar-collapse navbar-ex1-collapse">				<ul class="nav navbar-nav side-nav">					<li <?php echo e(isActive($active_class, 'dashboard')); ?>> 
					...
					<i class="fa fa-language" aria-hidden="true"></i> <?php echo e(getPhrase('languages')); ?> </a> </li>
					
					<li <?php echo e(isActive($active_class, 'users')); ?>> <a href="<?php echo e(URL_USERS); ?>"><i class=" icon-users"></i> <?php echo e(getPhrase('users')); ?> </a> </li>
					...
					<ul id="exams" class="collapse sidemenu-dropdown">
							<li><a href="<?php echo e(URL_QUIZ_CATEGORIES); ?>"> <i class="fa fa-random"></i><?php echo e(getPhrase('categories')); ?></a></li>
							<li><a href="<?php echo e(URL_QUIZ_QUESTIONBANK); ?>"> <i class="fa fa-question"></i><?php echo e(getPhrase('question_bank')); ?></a></li>

							<li><a href="<?php echo e(URL_QUIZZES); ?>"> <i class="icon-total-time"></i> <?php echo e(getPhrase('quiz')); ?></a></li>

							<li><a href="<?php echo e(URL_EXAM_TYPES); ?>"> <i class="fa fa-list"></i> <?php echo e(getPhrase('exam_types')); ?></a></li>

							<li><a href="<?php echo e(URL_EXAM_SERIES); ?>"> <i class="fa fa-list-ol"></i> <?php echo e(getPhrase('exam_series')); ?></a></li>
							<li><a href="<?php echo e(URL_INSTRUCTIONS); ?>"> <i class="fa fa-hand-o-right"></i> <?php echo e(getPhrase('instructions')); ?></a></li>
							<li><a href="<?php echo e(URL_MASTERSETTINGS_SUBJECTS); ?>"> <i class="icon-books"></i> <?php echo e(getPhrase('subjects_master')); ?></a></li>
							
							<li><a href="<?php echo e(URL_MASTERSETTINGS_TOPICS); ?>"> <i class="fa fa-database"></i> <?php echo e(getPhrase('subject_topics')); ?></a></li>
					...
					<ul id="coupons" class="collapse sidemenu-dropdown">
							<li><a href="<?php echo e(URL_COUPONS); ?>"> <i class="fa fa-list"></i><?php echo e(getPhrase('list')); ?></a></li>
							<li><a href="<?php echo e(URL_COUPONS_ADD); ?>"> <i class="fa fa-plus"></i><?php echo e(getPhrase('add')); ?></a></li>
					...
					<ul id="lms" class="collapse sidemenu-dropdown">
							<li><a href="<?php echo e(URL_LMS_CATEGORIES); ?>"> <i class="fa fa-random"></i><?php echo e(getPhrase('categories')); ?></a></li>
							<li><a href="<?php echo e(URL_LMS_CONTENT); ?>"> <i class="icon-books"></i><?php echo e(getPhrase('contents')); ?></a></li>
							<li><a href="<?php echo e(URL_LMS_SERIES); ?>"> <i class="fa fa-list-ol"></i><?php echo e(getPhrase('series')); ?></a></li>
					</ul>
					</li>
					...
					<ul id="reports" class="collapse sidemenu-dropdown">
						  	<li><a href="<?php echo e(URL_ONLINE_PAYMENT_REPORTS); ?>"> <i class="fa fa-link"></i><?php echo e(getPhrase('online_payments')); ?></a></li>
							<li><a href="<?php echo e(URL_OFFLINE_PAYMENT_REPORTS); ?>"> <i class="fa fa-chain-broken"></i><?php echo e(getPhrase('offline_payments')); ?></a></li>
							<li><a href="<?php echo e(URL_PAYMENT_REPORT_EXPORT); ?>"> <i class="fa fa-file-excel-o"></i><?php echo e(getPhrase('export')); ?></a></li>
					...
					<li <?php echo e(isActive($active_class, 'notifications')); ?> > 
						<a href="<?php echo e(URL_ADMIN_NOTIFICATIONS); ?>" ><i class="fa fa-bell-o" aria-hidden="true"></i>
					<?php echo e(getPhrase('notifications')); ?> </a> 
					
					</li>
					<li <?php echo e(isActive($active_class, 'sms')); ?> > 
						<a href="<?php echo e(URL_SEND_SMS); ?>" ><i class="icon-events" ></i> 
					SMS </a> 
					...
					<li <?php echo e(isActive($active_class, 'feedback')); ?> > 
						<a href="<?php echo e(URL_FEEDBACKS); ?>" ><i class="icon-inbox" ></i> 
					...
					<a data-toggle="collapse" data-target="#master_settings" href="<?php echo e(URL_MASTERSETTINGS_SETTINGS); ?>"><i class="icon-settings" ></i> 
					...
					<li <?php echo e(isActive($active_class, 'themes')); ?> > 
						<a href="<?php echo e(URL_THEMES_LIST); ?>" ><i class="fa fa-th-large" ></i> 
