        ...
        <div class="col-md-6">
            ...
            <form>
                ...
                $sno = 1; foreach($user_answers as $answer) { 
                    ...
                    ?>    
                    <li class="<?php echo e($correct_answer_class); ?>" > <span class="numbers-count bg-primary"><?php echo e($sno++); ?></span><?php echo e($answer); ?> </li>
                    <?php } ?>
        ...
        <div class="col-md-6">
            ...
            <form>
                ...
                <ul class="filling-blank answersheet">
                    ...
                    <li> <span class="numbers-count bg-primary"><?php echo e($sno++); ?></span><?php echo e($answer->answer); ?> </li>
                    <?php } ?>
