...
<div ng-if="question_type=='para' || question_type=='video' || question_type=='audio'">
    ...
    <fieldset class="form-group col-md-6"> 
        <?php echo e(Form::label('total_answers', __('messages.total_questions'))); ?>
    ...
    ?>
    <fieldset class="form-group col-md-6"> 
        <?php echo e(Form::label('total_options', __('messages.total_options'))); ?>
    ...
    <div class="col-md-12 question-block">
     ...
     <fieldset class="form-group" >
        ...
        <label ><?php echo e(__('messages.question')); ?> {{ $index+1 }}</label>
        <span class="text-red">*</span>
    ...
    <fieldset class="form-group col-md-6" ng-repeat="i in range(total_para_options) track by $index " ng-if="total_para_options >0 " >
        <label ><?php echo e(__('messages.option')); ?> {{ $index+1 }}</label> 
        <span class="text-red">*</span>
    ...
    <fieldset class="form-group col-md-12" >
          ...
          <label ><?php echo e(__('messages.answer')); ?> {{ $index+1 }}</label>
         <span class="text-red">*</span>
