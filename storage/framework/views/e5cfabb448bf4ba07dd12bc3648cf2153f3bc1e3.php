...
app.controller('prepareQuestions', function( $scope, $http, httpPreConfig,$sce) {
    ...
    $scope.keys = [];
    $scope.is_have_section = 0;
    $scope.type_exam = "<?php echo e($quiz_record->exam_type); ?>";
    ...
    $scope.initAngData = function(data) {
     ...
     $scope.subjectChanged = function(selected_number) {
        ...
        if(subject_id === undefined)
            return; 
        route = '<?php echo e(URL_QUIZ_GET_QUESTIONS); ?>';  
        data= {  _method: 'post', 
 ...
 $scope.addQuestion = function(question, subject) {
        ...
        // console.log(subject);
           ...
           <?php if($quiz_record): ?>
                ...
                <?php if($quiz_record->exam_type!='NSNT'): ?>
                    ...
                    <?php if($quiz_record->exam_type=='ST'): ?>
