					 ...
					 <fieldset class="form-group">
						...
						<?php echo e(Form::label('name', trans('home.Name'))); ?>
					...
					?>
					 ...
					 <fieldset class="form-group">
						...
						<?php echo e(Form::label('username', trans('home.Username') )); ?>
					...
					<?php endif; ?>
					 ...
					 <fieldset class="form-group">
						...
						<?php echo e(Form::label('email', trans('home.Email'))); ?>
					...
					<?php if(!$record): ?>
					 <fieldset class="form-group">
					 <?php echo e(Form::label('password', trans('home.Password'))); ?>
					 ...
					 <fieldset class="form-group">
					 <?php echo e(Form::label('confirm_password', trans('home.Confirm Password'))); ?>
                  ...
                  <?php endif; ?>
					...
					<fieldset class="form-group">
						...
						<?php echo e(Form::label('phone', trans('home.Phone'))); ?>
					...
					<div class="row">
						...
						<?php echo e(Form::label('address', trans('home.Billing Address'))); ?>
					...
					<fieldset class='col-sm-6'>
						...
						<?php echo e(Form::label('image', trans('home.Image'))); ?>
