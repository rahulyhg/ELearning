	...
	<div id="wrapper" class="<?php echo e($class); ?>">
		...
		<aside class="left-sidebar">			<div class="collapse navbar-collapse navbar-ex1-collapse">				<ul class="nav navbar-nav side-nav">					<li <?php echo e(isActive($active_class, 'dashboard')); ?>>
						<a href="<?php echo e(PREFIX); ?>">
							<i class="fa fa-fw fa-window-maximize"></i> <?php echo e(trans('home.Dashboard')); ?>

						</a>
					</li>

					<li <?php echo e(isActive($active_class, 'languages')); ?>> <a href="<?php echo e(URL_LANGUAGES_LIST); ?>">
					<i class="fa fa-fw fa-language" aria-hidden="true"></i> <?php echo e(trans('home.Languages')); ?> </a> </li>

					<li <?php echo e(isActive($active_class, 'users')); ?>> <a href="<?php echo e(URL_USERS); ?>"><i class="fa fa-fw fa-user-circle"></i> <?php echo e(trans('home.Users')); ?> </a> </li>
					...
					<?php echo e(trans('home.Exams')); ?> </a>

					<ul id="exams" class="collapse sidemenu-dropdown">

							<li><a href="<?php echo e(URL_QUIZ_CATEGORIES); ?>"> <i class="fa fa-fw fa-fw fa-random"></i><?php echo e(trans('home.Categories')); ?></a></li>
							<li><a href="<?php echo e(URL_QUIZ_QUESTIONBANK); ?>"> <i class="fa fa-fw fa-fw fa-question"></i><?php echo e(trans('home.Question Bank')); ?></a></li>

							<li><a href="<?php echo e(URL_QUIZZES); ?>"> <i class="icon-total-time"></i> <?php echo e(trans('home.Quiz')); ?></a></li>

							<li><a href="<?php echo e(URL_EXAM_TYPES); ?>"> <i class="fa fa-fw fa-list"></i> <?php echo e(trans('home.Exam Types')); ?></a></li>

							<li><a href="<?php echo e(URL_EXAM_SERIES); ?>"> <i class="fa fa-fw fa-list-ol"></i> <?php echo e(trans('home.Exam Series')); ?></a></li>
							<li><a href="<?php echo e(URL_INSTRUCTIONS); ?>"> <i class="fa fa-fw fa-hand-o-right"></i> <?php echo e(trans('home.Instructions')); ?></a></li>
							<li><a href="<?php echo e(URL_MASTERSETTINGS_SUBJECTS); ?>"> <i class="icon-books"></i> <?php echo e(trans('home.Subjects Master')); ?></a></li>

							<li><a href="<?php echo e(URL_MASTERSETTINGS_TOPICS); ?>"> <i class="fa fa-fw fa-database"></i> <?php echo e(trans('home.Subject Topics')); ?></a></li>
					...
					<?php echo e(trans('home.Coupons')); ?> </a>

					<ul id="coupons" class="collapse sidemenu-dropdown">
							<li><a href="<?php echo e(URL_COUPONS); ?>"> <i class="fa fa-fw fa-list"></i><?php echo e(trans('home.List')); ?></a></li>
							<li><a href="<?php echo e(URL_COUPONS_ADD); ?>"> <i class="fa fa-fw fa-plus"></i><?php echo e(trans('home.Add')); ?></a></li>
					...
					<ul id="lms" class="collapse sidemenu-dropdown">
							<li><a href="<?php echo e(URL_LMS_CATEGORIES); ?>"> <i class="fa fa-fw fa-random"></i><?php echo e(trans('home.Categories')); ?></a></li>
							<li><a href="<?php echo e(URL_LMS_CONTENT); ?>"> <i class="icon-books"></i><?php echo e(trans('home.Contents')); ?></a></li>
							<li><a href="<?php echo e(URL_LMS_SERIES); ?>"> <i class="fa fa-fw fa-list-ol"></i><?php echo e(trans('home.Series')); ?></a></li>
					</ul>
					</li>
					...
					<?php echo e(trans('home.Payment Reports')); ?> </a>

					<ul id="reports" class="collapse sidemenu-dropdown">
						  	<li><a href="<?php echo e(URL_ONLINE_PAYMENT_REPORTS); ?>"> <i class="fa fa-fw fa-link"></i><?php echo e(trans('home.Payment Reports')); ?></a></li>
							<li><a href="<?php echo e(URL_OFFLINE_PAYMENT_REPORTS); ?>"> <i class="fa fa-fw fa-chain-broken"></i><?php echo e(trans('home.Online Payments')); ?></a></li>
							<li><a href="<?php echo e(URL_PAYMENT_REPORT_EXPORT); ?>"> <i class="fa fa-fw fa-file-excel-o"></i><?php echo e(trans('home.Export')); ?></a></li>
					...
					<?php echo e(trans('home.Notifications')); ?> </a>
					...
					<?php echo e(trans('home.Messages')); ?> <small class="msg"><?php echo e($count = Auth::user()->newThreadsCount()); ?> </small></a>

					</li>
					<li <?php echo e(isActive($active_class, 'feedback')); ?> >
						<a href="<?php echo e(URL_FEEDBACKS); ?>" ><i class="fa fa-fw fa-commenting" ></i>
					<?php echo e(trans('home.Feedback')); ?> </a>
					...
					<?php echo e(trans('home.Master Settings')); ?> </a>
					...
					<ul id="master_settings" class="collapse sidemenu-dropdown">
							...
							<li><a href="<?php echo e(URL_MASTERSETTINGS_SETTINGS); ?>"> <i class="icon-settings"></i> <?php echo e(trans('home.Settings')); ?></a></li>
							<?php endif; ?>
					...
					<?php echo e(trans('home.Themes')); ?> </a>
