				...
				<div class="panel panel-custom">
					<div class="panel-heading">
						...
						<div class="pull-right messages-buttons">
							...
							<a href="<?php echo e(URL_QUESTIONBAMK_IMPORT); ?>" class="btn  btn-primary button" ><?php echo e(__('messages.import_questions')); ?></a>
							<a href="<?php echo e(URL_SUBJECTS_ADD); ?>" class="btn  btn-primary button" ><?php echo e(__('messages.add_subject')); ?></a>
