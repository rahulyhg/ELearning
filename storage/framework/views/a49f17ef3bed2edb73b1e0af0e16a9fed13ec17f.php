				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><a href="<?php echo e(URL_QUIZ_QUESTIONBANK); ?>"><?php echo e(__('messages.question_subjects')); ?></a></li>
				 ...
				 ng-controller="questionsController">
					<div class="panel-heading">
						<div class="pull-right messages-buttons">
							<a href="<?php echo e(URL_QUIZ_QUESTIONBANK); ?>" class="btn  btn-primary button" ><?php echo e(__('messages.list')); ?></a>
						</div>
