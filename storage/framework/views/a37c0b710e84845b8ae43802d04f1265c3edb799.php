				...
				<div class="panel panel-custom">
					...
					<div class="panel-heading">
						...
						<div class="pull-right messages-buttons">
							...
							<a href="<?php echo e(URL_QUIZ_ADD); ?>" class="btn  btn-primary button" ><?php echo e(__('messages.create')); ?></a>

						</div>

						<div class="pull-right messages-buttons">

							<a href="<?php echo e(URL_EXAM_SERIES); ?>" class="btn  btn-primary button" ><?php echo e(__('messages.create_series')); ?></a>
						...
						<table class="table table-striped table-bordered datatable" cellspacing="0" width="100%">
							...
							<thead>
								...
								<tr>
									...
									<th><?php echo e(__('messages.is_paid')); ?></th>

									<th><?php echo e(__('messages.total_marks')); ?></th>

									<th><?php echo e(__('messages.exam_types')); ?></th>
