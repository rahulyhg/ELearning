...
<div id="page-wrapper">
 		...
 		<div class="media state-media box-ws">
 			...
 			<div class="media-body">
				...
				<a href="<?php echo e(URL_STUDENT_EXAM_CATEGORIES); ?>"><?php echo e(trans('home.Quiz Categories')); ?></a>
 			</div>
 		</div>
 	</div>    
 	<div class="col-md-4 col-sm-6">
 		<div class="media state-media box-ws">
 			...
 			<div class="media-body">
				...
				<a href="<?php echo e(URL_STUDENT_EXAM_ALL); ?>"><?php echo e(trans('home.Quizzes')); ?></a>
 			</div>
 		</div>
 	</div> 
 	<div class="col-md-4 col-sm-6">
 		<div class="media state-media box-ws">
 			...
 			<div class="media-body">
				...
				<a href="<?php echo e(URL_PARENT_CHILDREN); ?>"><?php echo e(trans('home.Chilren')); ?></a>
 			</div>
 		</div>
 	</div>
				...
				<div class="row">
					<div class="col-md-6">
					     <div class="panel panel-custom">
					      <div class="panel-heading"><?php echo e(trans('home.Latest Quizzes')); ?></div>
						...
						<div class="col-md-6">
					     <div class="panel panel-custom">
							 ...
							 <div class="panel-heading"><?php echo e(trans('home.Latest LMS Series')); ?></div>
