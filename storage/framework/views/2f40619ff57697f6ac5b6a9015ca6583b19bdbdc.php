					...
					<div class="panel-body">
					 ...
					 <?php $button_name = getPhrase('update'); ?>
						...
						'method'=>'patch','novalidate'=>'','name'=>'formUsers ', 'files'=>'true' ))); ?>
						 ...
						 <h1><?php echo e(trans('home.Quiz And Exam Series')); ?></h1>
 				...
 				<?php 
					...
					<div class="col-md-3">
						<label class="checkbox-inline" >
							...
							<input type="checkbox" data-toggle="toggle" name="quiz_categories[<?php echo e($category->id); ?>]" data-onstyle="success" data-offstyle="default" <?php echo e($checked); ?>> <?php echo e(trans("home.$category->category")); ?>
