...
<div ng-if="question_type=='match'">
    ...
    <div ng-if="total_answers > 0" class="row">
     ...
     <fieldset class="form-group col-md-5" >
        <label ><?php echo e(__('messages.left_title')); ?></label> <span class="text-red">*</span>
     ...
     <fieldset class="form-group col-md-5" >
        <label ><?php echo e(__('messages.right_title')); ?></label> <span class="text-red">*</span>
    ...
    <fieldset class="form-group col-md-5" >
        <label ><?php echo e(__('messages.left_option')); ?> {{ $index+1 }}</label> <span class="text-red">*</span>
    ...
    <fieldset class="form-group col-md-5" >
        <label ><?php echo e(__('messages.right_option')); ?> {{ $index+1 }}</label> <span class="text-red">*</span>
    ...
    <fieldset class="form-group col-md-2" >
        <label ><?php echo e(__('messages.answer')); ?> {{ $index+1 }}</label> <span class="text-red">*</span>
   ...
   <h4><?php echo e(__('messages.2nd_languages')); ?></h4>

     <div ng-if="total_answers > 0" class="row">

     <fieldset class="form-group col-md-5" >

        <label ><?php echo e(__('messages.left_title')); ?> (<?php echo e(__('messages.2nd_languages')); ?>) </label>
     ...
     <fieldset class="form-group col-md-5" >
        ...
        <label ><?php echo e(__('messages.right_title')); ?> (<?php echo e(__('messages.2nd_languages')); ?>) </label>
    ...
    <fieldset class="form-group col-md-5" >
        ...
        <label ><?php echo e(__('messages.left_option')); ?> {{ $index+1 }} (<?php echo e(__('messages.2nd_languages')); ?>)</label>
    ...
    <fieldset class="form-group col-md-5" >
        ...
        <label ><?php echo e(__('messages.right_option')); ?> {{ $index+1 }} (<?php echo e(__('messages.2nd_languages')); ?>)</label>
